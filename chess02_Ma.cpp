...
bool Ma::move(SC x, SC y, const vector<Chess*>& ar)   //return TRUE if moving to (x,y) is valid, otherwise return FALSE
{
...
bool Ma::attack(SC x, SC y, const vector<Chess*>& ar) //the moving method and the attacking method of 马 are the same
{
