...
bool Xiang::move(SC x, SC y, const vector<Chess*>& ar)   //return TRUE if moving to (x,y) is valid, otherwise return FALSE
{
...
bool Xiang::attack(SC x, SC y, const vector<Chess*>& ar) //the moving method and the attacking method of 相/象 are the same
{
