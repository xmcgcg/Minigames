...
bool Shi::move(SC x, SC y, const vector<Chess*>& ar)   //return TRUE if moving to (x,y) is valid, otherwise return FALSE
{
	switch (Ycoord)
	{
...
bool Shi::attack(SC x, SC y, const vector<Chess*>& ar) //the moving method and the attacking method of 仕/士 are the same
{
