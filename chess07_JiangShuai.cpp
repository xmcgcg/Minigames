...
bool JiangShuai::move(SC x, SC y, vector<Chess*> ar) //return TRUE if moving to (x,y) is valid, otherwise return FALSE
{
...
bool JiangShuai::attack(SC x, SC y, vector<Chess*> ar) //the moving method and the attacking method of 帅/将 are the same
{
